    ...
    <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
        <div className="brutalist-card p-8 flex flex-col">
          ...
          <p className="font-sans text-brand-black font-medium mb-8 flex-1">
            Revisa los resultados detallados de los flujos automáticos sobre la interfaz gráfica y funcionalidades principales.
          </p>
          <Link to="/reports" className="brutalist-button inline-block text-center py-3">
            Ver Reportes &rarr;
          </Link>
        </div>
        ...
        <div className="brutalist-card p-8 flex flex-col">
          ...
          <Link to="/stress" className="brutalist-button inline-block text-center py-3">
        ...
        <div className="brutalist-card p-8 flex flex-col">
          ...
          <Link to="/audit" className="brutalist-button inline-block text-center py-3">
            Auditoría QA &rarr;
          </Link>
        </div>
      </div>
